...
export default function AudioAllProduct() {
    ...
    return (
        <div className='mt-5'>
            <h2 className='section-header__title show-sep text-center'>Best <span style={{ color: "#ff4f33" }}>Audio</span></h2>
            <div className='d-flex container justify-content-center gap-2 flex-wrap'>
                {Audio_Data.map((item, i) => (
                    <div key={i} className='Audio-Cart'>
                        <Link to={`/AudioProduct/${item.id}`} className='Img-Audio-main d-flex justify-content-center align-items-center'>
