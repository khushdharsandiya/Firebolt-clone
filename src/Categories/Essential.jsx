...
export default function Essential() {
    ...
    return (
        <div className='mt-5'>
            <h2 className='section-header__title show-sep text-center'>Essential  <span style={{ color: "#ff4f33" }}>Series</span></h2>
            <div className='d-flex container justify-content-center gap-2 flex-wrap'>
                {Essential_data.map((item, i) => (
                    <div key={i} className='Audio-Cart'>
                        <Link to={`/EssentialProduct/${item.id}`} className='Img-Audio-main d-flex justify-content-center align-items-center'>
