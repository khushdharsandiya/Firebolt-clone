...
export default function Bluetoothcalling() {
    ...
    return (
        <div className='mt-5'>
            <h2 className='section-header__title show-sep text-center'>Bluetooth  <span style={{ color: "#ff4f33" }}>Calling</span></h2>
            <div className='d-flex container justify-content-center gap-2 flex-wrap'>
                {Calling_Data.map((item, i) => (
                    <div key={i} className='Audio-Cart'>
                        <Link to={`/BluetoothProduct/${item.id}`} className='Img-Audio-main d-flex justify-content-center align-items-center'>
